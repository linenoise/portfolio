...
This is the codebase that runs [Danne Stayskal's portfolio site](http://danne.stayskal.com/).  It is developed using [nanoc](http://nanoc.stoneship.org/) and rsynced in static form to the server.
